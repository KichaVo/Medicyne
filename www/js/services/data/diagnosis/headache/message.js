App.factory('HeadacheMessage', function () {
  ...
  return {
    ...
    'M002': 'Over-the-counter (OTC) medications are not approriat for the severity of your current condition. Your condition may be serious and needs to be evaluated by a physician.',
